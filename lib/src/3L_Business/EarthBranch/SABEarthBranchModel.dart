class SABEarthBranchModel {
  ...
  Map earthTimeDictionary() {
    if (null == _earthTimeDictionary) {
      _earthTimeDictionary = {
        "子": "23:00~01:00",
        "丑": "01:00~03:00",
        "寅": "03:00~05:00",
        "卯": "05:00~07:00",
    ...
    return _earthTimeDictionary;
  }

  Map earthElement() {
    if (null == _earthElement) {
      _earthElement = {
        "子": "水",
        "丑": "土",
        "寅": "木",
    ...
    return _earthElement;
  }

  Map earthDirection() {
    if (null == _earthDirection) {
      _earthDirection = {
        "子": "正北方",
        "丑": "东北方",
        "寅": "东北方",
    ...
    return _earthDirection;
  }

  Map getSeasonStrong() {
    if (null == _myStrongData) {
      _myStrongData = Map();
      {
        Map data = {
          "子": "旺",
        ...
        _myStrongData["亥"] = data;
        _myStrongData["子"] = data;
      }
...

      {
        ...
        _myStrongData["寅"] = data;
        _myStrongData["卯"] = data;
      }

      {
        ...
        _myStrongData["巳"] = data;
        _myStrongData["午"] = data;
      }

      {
        ...
        _myStrongData["申"] = data;
        _myStrongData["酉"] = data;
      }
    }
    return _myStrongData;
  }
